...
parser.add_argument("--w_geo", type=float, help="regularization parameter for geometric similarity", default=10.0)
...
parser.add_argument("--prune_ratio", type=float, help="ratio of paths to be pruned out", default=0.4)
